...
const HowWork = () => {
    ...
    return (
        <div className='relative w-full py-16 md:py-20 lg:py-24 overflow-hidden'>
            <div className='absolute inset-0 bg-linear-to-br from-gray-50 via-white to-blue-50 dark:from-slate-950 dark:via-slate-900 dark:to-indigo-950 py-20 transition-colors duration-500'></div>
