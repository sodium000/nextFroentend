...
const CareerPage = () => {
    ...
    return (
        <div className="min-h-screen bg-white dark:bg-slate-950 transition-colors duration-500">
            <section className="relative w-full py-20 lg:py-32 overflow-hidden">
                ...
                <div className="    px-4 sm:px-6 lg:px-8 relative z-10">
                    <div className="max-w-4xl   text-center">
                        ...
                        <p className="text-xl md:text-2xl text-gray-600 dark:text-slate-400 leading-relaxed mb-8">
                    ...
                    <div className="max-w-6xl  ">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
                            {values.map((value, index) => (
                                <div
                                    key={index}
                                    className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-xl rounded-3xl p-8 shadow-xl dark:shadow-none hover:shadow-2xl dark:hover:shadow-indigo-500/10 transition-all duration-500 transform hover:-translate-y-2 border border-slate-200/60 dark:border-slate-700/60"
                                >
            ...
            <section id="open-positions" className="relative w-full py-16 overflow-hidden bg-linear-to-br from-indigo-50 to-purple-50 dark:from-indigo-950/30 dark:to-purple-950/30">
                <div className="    px-4 sm:px-6 lg:px-8">
                    <div className="max-w-6xl  ">
                        <div className="text-center mb-12">
                            <h2 className="text-4xl md:text-5xl font-black text-slate-900 dark:text-white mb-4">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            {openPositions.map((position, index) => (
                                ...
                                >
                                    <div className="flex items-start justify-between mb-4">
                                        <div>
                                            ...
                                            <div className="flex flex-wrap gap-2 mb-3">
                                                <span className="px-3 py-1 bg-indigo-100 dark:bg-indigo-500/20 text-indigo-600 dark:text-indigo-400 rounded-full text-xs font-bold">
                                                    {position.department}
                                                </span>
                                                <span className="px-3 py-1 bg-purple-100 dark:bg-purple-500/20 text-purple-600 dark:text-purple-400 rounded-full text-xs font-bold">
                                                    {position.type}
                                                </span>
                                            </div>
                                        </div>
                                    ...
                                    <button className="w-full px-6 py-3 bg-slate-900 dark:bg-white text-white dark:text-slate-900 rounded-xl font-bold hover:bg-indigo-600 dark:hover:bg-indigo-400 transition-all duration-300 shadow-lg hover:shadow-xl group-hover:scale-105">
                                        Apply Now
                                    </button>
                                </div>
                            ))}
                        ...
                        <div className="text-center mt-12">
                            <div className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-xl rounded-3xl p-8 shadow-xl border border-slate-200/60 dark:border-slate-700/60">
                                ...
                                <button className="px-8 py-4 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl font-bold transition-all duration-300 shadow-lg hover:shadow-xl">
